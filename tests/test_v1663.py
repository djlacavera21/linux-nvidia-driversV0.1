...
from nvlx.runtime_v1663 import MetricsDiagnosis, ReadinessDiagnosis, Runtime


class ReadinessLogicalDomainTests(unittest.TestCase):
    @staticmethod
    ...
    def test_readiness_diagnosis_rejects_ready_with_failed_exported_gate(self):
    ...
    def test_readiness_diagnosis_rejects_impossible_fresh_leadership(self):
        with self.assertRaises(ValueError):
            ReadinessDiagnosis(
    ...
    def test_live_runtime_downgrades_torn_authoritative_ready_capture(self):
        ...
        runtime.stats.inventory_fresh = False
        runtime.stats.terminating = False
        runtime.nvidia_preflight_ok = True

        diagnosis = runtime.readiness_diagnosis()
        self.assertFalse(diagnosis.controller_ready)
        self.assertFalse(diagnosis.inventory_fresh)

    def test_readyz_contradictory_typed_provider_fails_closed_without_fallback(self):
    ...
    def test_metrics_contradictory_nested_readiness_fails_static_500(self):
    ...
    def test_legacy_readiness_fallback_remains_unchanged(self):
        class Stats:
            api_reachable = True
            leader = False
            inventory_fresh = True
